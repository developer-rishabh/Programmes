...
def test_cdbn(pretrain_lr=0.1, pretraining_epochs=1000, k=1, \
    ...
    y = numpy.array([[1, 0],[ 0.34057815,  0.30821918,  0.34909857,,  0.23494515,
         0.8224674 ,  0.32125643],
       [ 0.28840451,  0.2530882 ,  0.28589727, ...,  0.18497065,
         0.80341023,  0.26417799],
       [ 0.69087569,  0.45546744,  0.69321325, ...,  0.4604992 ,
         0.84152457,  0.47511987]
                     [1, 0],
                     [1, 0],
                     [0, 1],
                     [0, 1],
